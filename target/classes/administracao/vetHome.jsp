...
<a href="/administracao" class='btn btn-info btn-sm'>Administração</a>
	<div class='container'>
		...
		<br>
		<a href="/administracao/vet/cadastro" class="btn btn-primary btn-sm">Cadastrar</a>
		<br>
		<h4>Lista de veterinários</h4>
		<table class="table table-striped">
			...
			<c:forEach items="${veterinarios}" var="veterinario"
				...
				<tr>
					...
					<td><a href="/administracao/vet/${veterinario.id}" class="link-primary"><c:out
